...
\begin{enumerate}
    ...
    \begin{jieda}
        首先根据$B \neq \varnothing$知$2m-1 \geq m+1$，即$m \geq 2$ \\ 根据$p$是真命题可知$A \cap B \neq \varnothing$故有$2 \leq 2m-1$且$5 \geq m+1$，解得$m \in [\dfrac{3}{2}, 4]$，结合$m \geq 2$，有$m \in [2, 4]$
    \end{jieda}
...
\begin{enumerate}
    ...
    \end{jieda}
    \item 设集合$A = \{x | x-3 < 2\}, B = \{x |3 < x < 3m+1\}$，若“$x \in A$”是“$x \in B$”的必要不充分条件，实数$m$的取值范围是\blkda{$(-\infty, \dfrac{4}{3}]$}.
    \begin{jieda}
